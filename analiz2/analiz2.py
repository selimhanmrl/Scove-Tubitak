    ...
    if not detection_line == (0,0):
        ...
        if not p.within(area):
            ...
            if calc.speed >2:
                ...
                cv2.putText(frame, f" Total Aktif Duvar Kesfi {total_aktif/100}", (550, 90), cv2.FONT_HERSHEY_SIMPLEX, 1, (157, 17, 24),3)
                cv2.putText(frame, f" Total Pasif Duvar Kesfi {total_pasif/100}", (550, 130), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0),3)
            elif calc.speed <=2:
                total_pasif = total_pasif +1
                cv2.putText(frame, f" Total Aktif Duvar Kesfi {total_aktif/100}", (550, 90), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0),3)
                cv2.putText(frame, f" Total Pasif Duvar Kesfi {total_pasif/100}", (550, 130), cv2.FONT_HERSHEY_SIMPLEX, 1, (157, 17, 24),3)    
