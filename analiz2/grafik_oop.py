...
# detection = open('detection_center.txt', 'r')
pts=roi_file.read()
...
while True:
    try:
        ...
        speed_graph.append(int(calc.speed))
        print(calc.speed)
        
        if calc.speed >2:
            cv2.putText(frame, " Akftif", (0, 180), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255),3)
        elif calc.speed <=2:
            cv2.putText(frame, " Pasif", (0, 180), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255),3)
